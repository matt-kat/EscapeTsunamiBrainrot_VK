...
function initializeBridge() {
    ...
    bridge
        ...
        .then(() => {
            ...
            unityLoader.src = 'Build/EscapeTsunamiBrainrot_VK.loader.js'
            unityLoader.onload = () => {
                createUnityInstance(
                    CANVAS,
                    {
                        dataUrl: 'Build/EscapeTsunamiBrainrot_VK.data.unityweb',
                        frameworkUrl: 'Build/EscapeTsunamiBrainrot_VK.framework.js.unityweb',
                        codeUrl: 'Build/EscapeTsunamiBrainrot_VK.wasm.unityweb',
                        streamingAssetsUrl: 'StreamingAssets',
                        companyName: 'DefaultCompany',
                        productName: 'RobloxTsunami',
